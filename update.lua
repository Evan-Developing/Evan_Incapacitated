...
Citizen.CreateThread(function()
    PerformHttpRequest("https://raw.githubusercontent.com/Evan-Developing/Evan_Incapacitated/main/version", checkVersion, "GET")
end)
